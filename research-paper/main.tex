...
\newcommand{\repourl}{https://github.com/ali-Hamza817/Code-Sentinel}
% Clickable superscript that navigates to the repo, with the URL in the
% page footer as footnote 1.
\newcommand{\repomark}{%
  \href{\repourl}{\textsuperscript{1}}%
  \footnotetext[1]{\textsc{CodeSentinel} is openly available at
    \url{\repourl}}%
}
